...
class AccountSettingsFeature implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'AccountSettingsFeature';
     ...
     *
     * @param int $meeting_capacity Set the maximum number of participants this user can have in a single meeting
     *
     * @return $this
     */
