...
class Webhook implements ModelInterface, ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if ((mb_strlen($this->container['auth_user']) > 128)) {
    ...
    public function setUrl($url)
    {
        if ((mb_strlen($url) > 256)) {
            throw new \InvalidArgumentException('invalid length for $url when calling Webhook., must be smaller than or equal to 256.');
        }
    ...
    {
        if ((mb_strlen($auth_user) > 128)) {
            throw new \InvalidArgumentException('invalid length for $auth_user when calling Webhook., must be smaller than or equal to 128.');
        }
    ...
    public function setAuthPassword($auth_password)
    {
        if ((mb_strlen($auth_password) > 64)) {
            throw new \InvalidArgumentException('invalid length for $auth_password when calling Webhook., must be smaller than or equal to 64.');
        }
