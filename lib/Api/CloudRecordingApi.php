...
class CloudRecordingApi
{
     ...
     * @param  string $action The recording delete action (optional, default to trash)
     *
     ...
     *
     * @param  string $meeting_id The meeting ID or meeting UUID. If given meeting ID, will take the last meeting instance. (required)
     * @param  \Swagger\Client\Model\RecordingSettings $body Meeting recording Settings (required)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     ...
     * @param  string $mc Query mc (optional, default to false)
     * @param  bool $trash Query trash (optional, default to false)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\RecordingMeetingList
     */
    public function recordingsList($user_id, $from, $to, $page_size = '30', $next_page_token = null, $mc = 'false', $trash = 'false')
    {
        list($response) = $this->recordingsListWithHttpInfo($user_id, $from, $to, $page_size, $next_page_token, $mc, $trash);
        return $response;
    }
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\RecordingMeetingList, HTTP status code, HTTP response headers (array of strings)
     */
    public function recordingsListWithHttpInfo($user_id, $from, $to, $page_size = '30', $next_page_token = null, $mc = 'false', $trash = 'false')
    {
        $returnType = '\Swagger\Client\Model\RecordingMeetingList';
        $request = $this->recordingsListRequest($user_id, $from, $to, $page_size, $next_page_token, $mc, $trash);
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\RecordingMeetingList',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function recordingsListAsync($user_id, $from, $to, $page_size = '30', $next_page_token = null, $mc = 'false', $trash = 'false')
    {
        return $this->recordingsListAsyncWithHttpInfo($user_id, $from, $to, $page_size, $next_page_token, $mc, $trash)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function recordingsListAsyncWithHttpInfo($user_id, $from, $to, $page_size = '30', $next_page_token = null, $mc = 'false', $trash = 'false')
    {
        $returnType = '\Swagger\Client\Model\RecordingMeetingList';
        $request = $this->recordingsListRequest($user_id, $from, $to, $page_size, $next_page_token, $mc, $trash);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function recordingsListRequest($user_id, $from, $to, $page_size = '30', $next_page_token = null, $mc = 'false', $trash = 'false')
    {
        ...
        if ($from === null || (is_array($from) && count($from) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $from when calling recordingsList'
            );
        }
        // verify the required parameter 'to' is set
        if ($to === null || (is_array($to) && count($to) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $to when calling recordingsList'
            );
        }
